"""
Django settings for walking_buddy project.
"""
...
# Add ngrok domains dynamically for development
if DEBUG:
...
MIDDLEWARE = [
    ...
    'users.middleware.DatabaseQueryMonitorMiddleware',
]

ROOT_URLCONF = 'django_walking_buddy.urls'
...
# Channels configuration (simplified for development)
CHANNEL_LAYERS = {
    'default': {

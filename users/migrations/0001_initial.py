    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('walking_pace', models.CharField(choices=[('slow', 'Slow'), ('moderate', 'Moderate'), ('fast', 'Fast')], default='moderate', max_length=10)),
                ('preferred_distance', models.DecimalField(decimal_places=2, default=5.0, max_digits=5)),
